...
INSERT INTO 'iot_auth_access' ('role_id', 'rule_id')
VALUES
  (2,3),
  (1,2),
  (2,1),
...
/*!40000 ALTER TABLE 'iot_auth_access' ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table iot_auth_rule
# ————————————————————
...
VALUES
 ...
 /* (3,'Admin/Index','admin/index',0,1483502713,NULL),
  ...
  !40000 ALTER TABLE 'iot_auth_rule' ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO 'iot_log_record' ('id', 'user_id', 'ip', 'os', 'browser', 'remark', 'create_time')
VALUES
...
!40000 ALTER TABLE 'iot_log_record' ENABLE KEYS ;
UNLOCK TABLES;
*/

# Dump of table iot_role
# ————————————————————
